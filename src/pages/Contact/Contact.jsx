    ...
    <div className="contact">
      <header className="contact__header">
        ...
        <p className="contact__subtitle">
          ¿Tienes preguntas sobre la adopción? ¿Quieres conocer más sobre
          nuestros gatitos? ¡Estamos aquí para ayudarte a encontrar tu compañero
          perfecto!
        </p>
      </header>
        ...
        <div className="contact__success">
          <div className="contact__success-message">
            <div className="contact__success-icon">
              <svg
                className="contact__success-icon-svg"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
                viewBox="0 0 24 24"
                ...
                <div className="contact__submit">
                  <button
                    ...
                    className={`contact__submit-button ${
                      loading ? "contact__submit-button--loading" : ""
                    }`}
                    disabled={loading}
                  >
                    {loading ? (
                      <div className="contact__loading">
                        <div className="contact__spinner">
                          ...
                          >
                            <circle
                              className="contact__spinner-circle"
                              cx="25"
                              cy="25"
                              r="20"
                              fill="none"
                            ...
                            />
                            <path
                              className="contact__spinner-path"
                              fill="none"
                              strokeWidth="5"
