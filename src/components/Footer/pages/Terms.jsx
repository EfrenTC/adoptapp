  ...
  return (
    <div className="terms-container">
      <div className="terms-content">
        ...
        <p>
          Bienvenido a <strong>Adopta un Gatito</strong>. Al utilizar nuestro sitio web, aceptas cumplir con los siguientes términos y condiciones. Por favor, léelos con atención.
        </p>
        ...
        <p>
          Todo el contenido generado por el equipo de <strong>Adopta un Gatito</strong> (textos, diseño, código) está protegido por derechos de autor. No está permitida su reproducción sin autorización previa.
        </p>
        ...
        <em>Última actualización: julio 2025</em>
      </div>
    </div>
  );
};
