  ...
  return (
    <div className="privacy-container">
      <div className="privacy-content">
        ...
        <h2>7. Contacto</h2>
        <p>
          Si tienes dudas sobre esta política o quieres ejercer tus derechos relacionados con la protección de datos, puedes contactarnos a través del formulario de contacto (próximamente).
        </p>
